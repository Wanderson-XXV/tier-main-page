...
const WhoAreYouLg = () => {
    return (
        <div className={" hidden lg:flex  h-screen w-screen bg-off-white flex-col justify-center md:flex-row gap-6 max-h-[100vh] py-8 px-10"}>
            {/* Card 1 */}
            <Card
